...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-10-2019 a las 21:42:12
...
INSERT INTO `operador` (`asdas`, `id`, `numero_op`, `nombre`, `tarea`, `cantidad`, `no_conforme`, `cantidad_fallas`, `inicial`, `hora_inicial`, `final`, `hora_final`, `eficencia`, `eficacia`) VALUES
(0, 1, '5002', 'jhon', 'PEGAR TIRAS CON SILICONA', 800, '0', 'maquina.mala', '2019/10/30', '06:00', '2019/10/30', '14:20', 'INF', '100');
